...
var AssemblyDetailPage = /** @class */ (function (_super) {
    __extends(AssemblyDetailPage, _super);
    ...
    AssemblyDetailPage.prototype.Ready = function () {
        var _this = this;
        ...
        Base.Helpers.AjaxService("POST", this.options.urlGet + "/" + this.options.DllId, null, function (data) {
            if (data) {
                // set title
                $("#h2name").text(data.Name);
                $("#h2sname").text(data.FullName);
                // Cout data
                data.Namespaces.forEach(function (item) {
                ...
                _this.assemblyData = data.Namespaces;
    ...
    AssemblyDetailPage.prototype.setErrorList = function (data) {
        var _this = this;
    ...
    AssemblyDetailPage.prototype.showErrorsList = function () {
    ...
    AssemblyDetailPage.prototype.setNamespaces = function (namespaces) {
        var _this = this;
    ...
    AssemblyDetailPage.prototype.loadTypeBases = function (element) {
        var _this = this;
    ...
    AssemblyDetailPage.prototype.loadType = function (element) {
    ...
    AssemblyDetailPage.prototype.setPopOver = function (element) {
        var self = this;
        element.popover({
            trigger: "focus",
            html: true,
    ...
    AssemblyDetailPage.prototype.getPopOverElement = function (element, contentType) {
        var name = element.attr("data-namespace");
    ...
    AssemblyDetailPage.prototype.getNameSpaceData = function (nameSpace) {
    ...
    AssemblyDetailPage.prototype.getTypeBaseClassData = function (nameSpace, typeName, metaType) {
    ...
    AssemblyDetailPage.prototype.getSubTypeBase = function (nameSpace, typeName, subName, metaType, metaSubType) {
    ...
    return AssemblyDetailPage;
}(Base.Page));
//# sourceMappingURL=AssemblyDetails.js.map